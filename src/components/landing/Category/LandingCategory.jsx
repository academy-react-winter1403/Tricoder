...
const LandingCategory = () => {
  ...
  return (
    <motion.div
      ...
      className="h-fit my-30 flex justify-center items-center mx-auto  relative 
    ...
    >
      ...
      <motion.div
        variants={container}
        className="grid grid-cols-2 grid-rows-2 gap-8  absolute -left-30
        ...
        {CategoryItem.map((data, ind) => (
          ...
          >
            ...
            <p
              ...
              max-md:text-xl max-md:mt-2"
            >
              {data.title}
            </p>
            <p
              className="text-[#455A64] text-center mt-5 tracking-tight mx-10
              max-md:text-[11px] max-md:mt-1"
            >
              {data.desc}
            </p>
          </motion.div>
