...
const HeroSection = () => {
  return (
    ...
    max-md:h-80' style={{ backgroundImage: "url('../../../../public/landing/hero-bg.png')" , backgroundRepeat:"no-repeat", backgroundSize:"100%" }}>
      {/* <img src='./public/landing/hero-bg.png ' className='w-full relative  ' alt='' /> */}

      <div className='max-lg:'>
        <div className='px-96  text-center tracking-tight whitespace-nowrap 
        max-md:px-8 pt-20 max-lg:px-30 max-lg:pt-1'>
          <p className='text-2xl font-medium  pt-30
        max-md:hidden'>پلتفرم اموزش طراحی وب</p>
          <p className='text-[80px] font-black
        max-md:text-2xl max-lg:text-5xl'>مرجع اموزش برنامه نویسی</p>
          <p className='text-2xl font-medium 
        max-md:hidden max-lg:text-xl'>مرجع اموزش زنده و تعاملی دسترسی به بیش از هفت هزار ویدیوی اموزشی به زبان فارسی .</p>

          <input className='w-182 pr-5 h-14 bg-[#FFF] rounded-2xl  text-[#607D8B] my-15
        max-md:w-[300px] max-md:h-7 text-xs max-md:pr-3 max-md:my-3 max-md:rounded-[10px]' placeholder='چی میخوای یاد بگیری ؟' />
      ...
      <div className='w-38 h-112   -mt-120  mr-314
      ...
      <div className='w-39 h-112 -mt-120 mr-30
      max-md:hidden max-lg:hidden'>
