...
const CoursePage = () => {
    ...
    return (
        ...
        <div className="hidden md:flex bg-[#6033FE] text-white text-center py-4 w-full px-9 rounded-[10px] whitespace-nowrap">
        ...
        {myCourse.map((data, ind) => (
          <div
            key={ind}
            className="flex flex-col md:flex-row gap-4 text-right text-sm md:text-center bg-gray-200 p-4 md:py-3.5 md:px-10 rounded-[10px] leading-8">
