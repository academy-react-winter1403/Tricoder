    ...
    <div>
        <div className='rounded-3xl shadow-2xl flex flex-col gap-6 px-8 py-8'>
              ...
              <div className='flex flex-col gap-4 items-center'>
                <input  onChange={(event) => {handleSubmit(event.target.value)}} className='h-25 w-full pr-4 border-2 border-[#CFD8DC]  rounded-2xl text-sm text-[#607D8B] leading-3' placeholder='نظر خودتو بنویس...' />
